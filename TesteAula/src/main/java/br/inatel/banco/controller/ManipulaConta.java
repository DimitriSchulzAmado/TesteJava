...
public class ManipulaConta {
    ContaBaseServices ContaCorrente;
    ContaBaseServices ContaPoupanca;
    ...
    public void menuInicial() {
        ...
        teclado.nextLine(); // é como o cin.ignore() no c++
    ...
    public void menuConta(ContaBaseServices Conta) {
        short op = 0;
        while(op != 3){
            ...
            switch (op) {
                case 1:
                    ...
                    // retorno do metodo depositovalor
    ...
    public String depositarValor(ContaBaseServices Conta, double valor, String nome) {
    ...
    public String pagamentoConta(ContaBaseServices Conta, double valor, String nome) {
